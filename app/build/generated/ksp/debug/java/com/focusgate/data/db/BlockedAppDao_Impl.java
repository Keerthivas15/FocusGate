...
public final class BlockedAppDao_Impl implements BlockedAppDao {
  ...
  public BlockedAppDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfBlockedAppEntity = new EntityInsertionAdapter<BlockedAppEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR IGNORE INTO `blocked_apps` (`packageName`) VALUES (?)";
      }
  ...
  @Override
  public Object delete(final String pkg, final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
  ...
  @Override
  public Flow<List<String>> observeAll() {
    final String _sql = "SELECT packageName FROM blocked_apps";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"blocked_apps"}, new Callable<List<String>>() {
      @Override
      @NonNull
  ...
  @Override
  public Object getAll(final Continuation<? super List<String>> $completion) {
    final String _sql = "SELECT packageName FROM blocked_apps";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
  ...
  @Override
  public Object exists(final String pkg, final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM blocked_apps WHERE packageName = ?";

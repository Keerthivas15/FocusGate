...
public final class FocusGateDatabase_Impl extends FocusGateDatabase {
  ...
  protected SupportSQLiteOpenHelper createOpenHelper(@NonNull final DatabaseConfiguration config) {
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(1) {
      ...
      public void createAllTables(@NonNull final SupportSQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE IF NOT EXISTS `credits` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `earnedAt` INTEGER NOT NULL, `expiresAt` INTEGER NOT NULL, `used` INTEGER NOT NULL)");
        db.execSQL("CREATE TABLE IF NOT EXISTS room_master_table (id INTEGER PRIMARY KEY,identity_hash TEXT)");
        db.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '28dd087a924b9aa92b0cb8d6de38be2c')");
      }
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoBlockedApps.equals(_existingBlockedApps)) {
          return new RoomOpenHelper.ValidationResult(false, "blocked_apps(com.focusgate.data.db.BlockedAppEntity).\n"
                  + " Expected:\n" + _infoBlockedApps + "\n"
                  + " Found:\n" + _existingBlockedApps);
        }
        final HashMap<String, TableInfo.Column> _columnsCredits = new HashMap<String, TableInfo.Column>(4);
        _columnsCredits.put("id", new TableInfo.Column("id", "INTEGER", true, 1, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCredits.put("earnedAt", new TableInfo.Column("earnedAt", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCredits.put("expiresAt", new TableInfo.Column("expiresAt", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        _columnsCredits.put("used", new TableInfo.Column("used", "INTEGER", true, 0, null, TableInfo.CREATED_FROM_ENTITY));
        ...
        if (!_infoCredits.equals(_existingCredits)) {
          return new RoomOpenHelper.ValidationResult(false, "credits(com.focusgate.data.db.CreditEntity).\n"
                  + " Expected:\n" + _infoCredits + "\n"
                  + " Found:\n" + _existingCredits);
        }
        return new RoomOpenHelper.ValidationResult(true, null);
      }
    }, "28dd087a924b9aa92b0cb8d6de38be2c", "023b13127e9eba5d3d1b76afb9fe2df7");
  ...
  protected InvalidationTracker createInvalidationTracker() {
    ...
    return new InvalidationTracker(this, _shadowTablesMap, _viewTables, "blocked_apps","credits");
  }
